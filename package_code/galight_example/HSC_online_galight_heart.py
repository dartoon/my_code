...
apertures[0].b = 14
import copy
ap = copy.deepcopy(apertures[0])
ap.theta = ap.theta + 40/180*np.pi 
ap_0 = copy.deepcopy(apertures[0])
ap_0.theta = ap_0.theta - 10/180*np.pi 
apertures = [ap_0, ap]
...
# host_G = fit_run_l[0].fitting_specify_class.kwargs_data['image_data'] #- fit_run_l[0].image_ps_list[0]
# host_R = fit_run_l[1].fitting_specify_class.kwargs_data['image_data'] #- fit_run_l[0].image_ps_list[0]
# host_I = fit_run_l[2].fitting_specify_class.kwargs_data['image_data'] #- fit_run_l[2].image_ps_list[0]
plt_fits_color([fit_run_l[i].fitting_specify_class.kwargs_data['image_data']- fit_run_l[i].image_ps_list[0] for i in [2,1,0]])
# import matplotlib.pyplot as plt
# plt_fits(host_I-host_G)
# plt.imshow(-np.log10(host_G)*2.5+np.log10(host_I)*2.5,vmin=1 , vmax=2)
# plt.colorbar()
# plt.show()