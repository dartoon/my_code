...
#    sf_factor = sf_factor/np.exp(sf_sigma**2/2)
    ...
    post1, post_dis1 = posterior((2.35, a1, mbh_max, mbh_min), m1_obs, m_noise_level, sf_factor,z_inf, r_detail = True)
    post2, post_dis2 = posterior((2.55, a1, mbh_max, mbh_min), m1_obs, m_noise_level, sf_factor,z_inf, r_detail = True)
