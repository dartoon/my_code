...
#
#if use_method == 'med':
#    filename = 'test1_0_med_obsun{0}.txt'.format(int(m_noise_level*100))   #obsun means the std are from the obs data rather than true data
#elif use_method == 'exp':
#    filename = 'test1_1_trans_exp_obsun{0}.txt'.format(int(m_noise_level*100))
#
...
#    m1_sig_fake = m1_obs * m_noise_level     #The fake "sigma"
