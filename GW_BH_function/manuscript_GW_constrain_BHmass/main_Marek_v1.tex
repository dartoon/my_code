...
\tablecomments{The catalog of simulated thousand BBH inspiral events is used to test the inference of the BHMF from the data attainable in forthcoming next generation GW detector -- the ET.
}
\end{deluxetable}
