...
filename = '/Users/Dartoon/Astro/Projects/my_code/projects/2020_HSC_to_numerical_simulation/Horizon/outt00266_halo_gal_centralBHs_2reff'
zs = 1.5
...
for ii in range(1):
    ...
    # pdf_values = mvn.pdf(np.column_stack((x0, y0)))
    # threshold = 0.3  # Adjust this threshold as needed
    # boolean_array = pdf_values > threshold
    # Apply the boolean array to (x0, y0) to obtain (x1, y1)
    # x1 = x0[boolean_array]
    # y1 = y0[boolean_array]
    ...
    # matched_samples = []
    # while len(matched_samples) < 200:
    #     generated_sample = np.random.multivariate_normal(parent_mean, parent_cov, 1)
    ...
    def lfit(x,m = 1/0.9811,c = 2.545/0.9811):
        ...
        # m = 1/0.9811
        # c = 2.545/0.9811
        return m*x+c+0.23   #!!! For IMF correction
