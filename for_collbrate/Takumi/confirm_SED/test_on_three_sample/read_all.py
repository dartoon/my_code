...
for i in range(11,12):
    ...
    print(idx)
    steller_file = glob.glob('esti_smass_lines/'+str(idx)+'/SFH_*.fits')[0]
    
    gsf.run_gsf_all('esti_smass_lines/'+str(idx)+'/sample.input', 6, idman=None)
    ...
    print(target_id,  float(info['Mstel_16']) , float(info['Mstel_50']) , float(info['Mstel_84']) )
