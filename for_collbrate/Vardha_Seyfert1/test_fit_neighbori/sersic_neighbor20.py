...
for i in range(len(namelist)):
    ...
    kwargs_source_sigma.append({'n_sersic': 0.5, 'R_sersic': 0.5, 'e1': 0.1, 'e2': 0.1, 'center_x': 0.1, 'center_y': 0.1})
    kwargs_lower_source.append({'e1': -0.5, 'e2': -0.5, 'R_sersic': 0.04, 'n_sersic': 0.5, 'center_x': -0.1, 'center_y': -0.1})
    kwargs_upper_source.append({'e1': 0.5, 'e2': 0.5, 'R_sersic': 30., 'n_sersic': 6,'center_x': 0.1, 'center_y': 0.1})
