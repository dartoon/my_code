...
for band in bands:
    ...
    for file in files:
        ...
        plt.imshow(fit_run.fitting_specify_class.kwargs_data['image_data'], cmap=my_cmap, 
        ...
        filename = 'figs/'+date+band+'.png'
        plt.savefig(filename)
        filename_list.append(filename)
        plt.close()     

    with imageio.get_writer('figs/'+band+'_days.gif', mode='I', fps=1) as writer:
