...
z_ = '_z0.7'
# folder = './SED_fit_JWST' #
# folder = './SED_fit_JWST_F814W_F606W' #
# folder = './SED_fit_JWST_VIS' #
# folder = './SED_fit_JWST_F814W06mag_VIS' #
folder = './SED_fit_JWST_F814W03mag_F606W06mag_VIS' #
folder += z_
...
spec1d_file = glob.glob('Generate_template{0}/gsf_spec*.fits'.format(z_))[0]
spec1d = pyfits.open(spec1d_file)  
name_spec = spec1d[1].columns
unit =  spec1d[1].header['TUNIT3']
table_spec = spec1d[1].data
...
seaborn.reset_orig()
plt.rcParams["font.family"] = "sans-serif"
plt.plot(wave/10000., f_50, 'red', alpha=0.4, zorder = 1)
