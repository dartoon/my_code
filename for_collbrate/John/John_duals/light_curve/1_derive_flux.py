...
for folder in folders[35:]:    
    ...
    for file in files:
        ...
        data_process.find_PSF(radius = 20, PSF_pos_list = [PSF_loc], pos_type = 'wcs',)
        ...
        fit_run = FittingProcess(fit_sepc, savename = name+'-{0}-band{1}'.format(folder,band), fitting_level='norm')
