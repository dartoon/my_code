...
def gen_fit_id(folder_name, ra, dec, file_name,cut_frame=120, subbkl=False):
    '''
    ...
    if subbkl == True:
        bkg = est_bkg(sci_data, pltshow=0)
...
#    print "the pixel of the QSO:", QSO_x, QSO_y 
    ...
    if subbkl == True:
        QSO_bkg = cut_image(bkg, center, cut_frame)
    else:
        QSO_bkg = 'Not account QSO bkg'
#    print "PSF_name", PSF_name
    ...
    return QSO_im, err_map, QSO_bkg, PSF, pix_scale, zp, center, [load_RA, load_DEC]
