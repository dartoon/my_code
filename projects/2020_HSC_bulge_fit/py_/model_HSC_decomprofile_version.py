...
from decomprofile.fitting_specify import FittingSpecify
...
def condition_bulgedisk(kwargs_lens, kwargs_source, kwargs_lens_light, kwargs_ps, kwargs_special, kwargs_extinction):
    logL = 0
    phi0, q0 = param_util.ellipticity2phi_q(kwargs_lens_light[1]['e1'], kwargs_lens_light[1]['e2'])
    phi1, q1 = param_util.ellipticity2phi_q(kwargs_lens_light[2]['e1'], kwargs_lens_light[2]['e2'])
    ...
    fit_run_1 = FittingProcess(fit_sepc_1, savename = save_name+'bulge+disk_2nd')
