...
filt = 'F150W'
files = glob.glob(run_folder+'fit_material/data_process_idx*_*{0}*_*FOVpsf*.pkl'.format(filt))
files.sort()
collect_info = []
...
PSF_lib_files = glob.glob('stage3_all/'+'material/*'+filt[:-1]+'*_PSF_Library_idx{0}.pkl'.format(1))[0]
