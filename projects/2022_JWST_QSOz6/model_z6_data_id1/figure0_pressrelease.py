...
color = 'white'
# text='5"'
# text=str(round(5/arc_per_kpc*3261.56/10**4))+'x10$^4$ light years'
text='10$^5$ light years'
...
# text='1"'
# text=str(round(1.111/arc_per_kpc*3261.56/10**4))+'x10$^4$ light years'
text='10$^4$ light years'
dist=1.111/2/data_process.deltaPix
p0 = d / 15.
axins.plot([320, 320 + dist], [320, 320], linewidth=3, color=color)
axins.text(350 + dist / 2., 320 + 0.01 * d, text, fontsize=16, color=color, ha='center')
...
mark_inset(ax, axins, loc1=loc1, loc2=loc2, fc="none", ec="0.6", linewidth=0)
ax.set(frame_on=False)  # New

# plt.savefig('/Users/Dartoon/Downloads/field_overview{0}.pdf'.format(filt))
plt.show()