...
<html>
    ...
    <body>
        ...
        <table cellspacing="0" cellpadding="4" rules="all" style="border-width:5px; border-style:solid; border-collapse:collapse;">
            ...
            <tr>
                <td>mast:HST/product/ibje26010_drz.fits</td>
                <td>HST/ibje26010/ibje26010_drz.fits</td>
                <td>PUBLIC</td>
                <td>OK</td>
                <td>anonymous</td>
            </tr>
...
cat <<EOT
<<< Downloading File: mast:HST/product/ibje26010_drz.fits
                  To: ${DOWNLOAD_FOLDER}/HST/ibje26010/ibje26010_drz.fits
EOT

curl --globoff --location-trusted -f --progress-bar --create-dirs $CONT --output ./${DOWNLOAD_FOLDER}'/HST/ibje26010/ibje26010_drz.fits' 'https://mast.stsci.edu/api/v0.1/Download/file?bundle_name=MAST_2021-07-04T1907.sh&uri=mast:HST/product/ibje26010_drz.fits'
