...
<html>
    ...
    <body>
        ...
        <table cellspacing="0" cellpadding="4" rules="all" style="border-width:5px; border-style:solid; border-collapse:collapse;">
            ...
            <tr>
                <td>mast:HST/product/u8pu4901m_c0f.fits</td>
                <td>HST/u8pu4901m/u8pu4901m_c0f.fits</td>
                <td>PUBLIC</td>
                <td>OK</td>
                <td>anonymous</td>
            </tr>
            ...
            <tr>
                <td>mast:HST/product/u8pu4901m_c1f.fits</td>
                <td>HST/u8pu4901m/u8pu4901m_c1f.fits</td>
                <td>PUBLIC</td>
                <td>OK</td>
                <td>anonymous</td>
            </tr>
...
cat <<EOT
<<< Downloading File: mast:HST/product/u8pu4901m_c1f.fits
                  To: ${DOWNLOAD_FOLDER}/HST/u8pu4901m/u8pu4901m_c1f.fits
EOT

curl --globoff --location-trusted -f --progress-bar --create-dirs $CONT --output ./${DOWNLOAD_FOLDER}'/HST/u8pu4901m/u8pu4901m_c1f.fits' 'https://mast.stsci.edu/api/v0.1/Download/file?bundle_name=MAST_2021-07-04T1907.sh&uri=mast:HST/product/u8pu4901m_c1f.fits'
...
cat <<EOT
<<< Downloading File: mast:HST/product/u8pu4901m_c0f.fits
                  To: ${DOWNLOAD_FOLDER}/HST/u8pu4901m/u8pu4901m_c0f.fits
EOT

curl --globoff --location-trusted -f --progress-bar --create-dirs $CONT --output ./${DOWNLOAD_FOLDER}'/HST/u8pu4901m/u8pu4901m_c0f.fits' 'https://mast.stsci.edu/api/v0.1/Download/file?bundle_name=MAST_2021-07-04T1907.sh&uri=mast:HST/product/u8pu4901m_c0f.fits'
