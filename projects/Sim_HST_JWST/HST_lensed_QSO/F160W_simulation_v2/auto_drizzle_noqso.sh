...
for id in 702 703 705 706 707 708 709 710 711 712 713 713 714 715 717 718 719 720 721 724 727 728 729 730 731 733 734 735 736 737 738 739 740 741 742 743 744 745 747 748 749 751 752 753 754 755 757 759 760
do
cp -r ../../drizzle_F160W_temp/* sim_lens_noqso_ID_subg30_${id}
cd sim_lens_noqso_ID_subg30_${id}
python header.py
