...
filtname = 'sim_lens_noqso_ID_221_drizzled/sim_kwargs.pkl'
model_lists, para_s, lens_info= pickle.load(open(filtname,'rb'))
...
lens_data = pyfits.getdata('sim_lens_noqso_ID_221_drizzled/Drz_QSO_image.fits')
framesize = 99
...
psf = pyfits.getdata('sim_lens_noqso_ID_221_drizzled/Drz_PSF.fits')
psf_fsize = 79
ct = int((len(lens_data) - psf_fsize)/2)
psf = psf[ct:-ct,ct:-ct]
...
kwargs_data = sim_util.data_configure_simple(numPix = framesize, deltaPix = deltaPix)
