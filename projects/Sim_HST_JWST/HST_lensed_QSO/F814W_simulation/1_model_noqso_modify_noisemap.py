...
savename = 'result_quicktest_subg3.pkl'
with_qso_savename = 'result_quicktest_subg3.pkl'
...
#        fixed_lens, fixed_source, fixed_lens_light, fixed_ps, fixed_cosmo = fix_setting
        ...
        kwargs_lower_lens_light.append({'e1': kwargs_lens_light_list[0]['e1']-0.001, 'e2': kwargs_lens_light_list[0]['e2']-0.001, 'R_sersic': 0.01, 'n_sersic': 0.5, 'center_x': kwargs_lens_light_list[0]['center_x']-1*deltaPix, 'center_y':  kwargs_lens_light_list[0]['center_y']-1*deltaPix})
        kwargs_upper_lens_light.append({'e1': kwargs_lens_light_list[0]['e1']+0.001, 'e2': kwargs_lens_light_list[0]['e2']+0.001, 'R_sersic': 10, 'n_sersic': 8, 'center_x': kwargs_lens_light_list[0]['center_x']+1*deltaPix, 'center_y': kwargs_lens_light_list[0]['center_y']+1*deltaPix})
...
#        cosmo = FlatLambdaCDM(H0=70, Om0=0.3, Ob0=0.)  #!!!Wrong cosmos4
