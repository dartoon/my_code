...
# if need smooth
#==============================================================================
data_fix=smooth_edge_bump(data_fix, r_out=31, thre=0.17)
data_fix=smooth_edge_bump(data_fix, r_out=57, thre=0.11)
data_fix=smooth_edge_bump(data_fix, r_out=110, thre=0.08)
