...
# if need smooth
#==============================================================================
data_fix=smooth_edge_bump(data_fix, r_out=45, thre=1)
data_fix=smooth_edge_bump(data_fix, r_out=76, thre=0.558)
data_fix=smooth_edge_bump(data_fix, r_out=95, thre=0.449)
data_fix=smooth_edge_bump(data_fix, r_out=127, thre=0.29)

data_fix -= 0.226999# np.median(data_fix[0:35,0:35])  # subtract a "background" value; or -np.median(data_rehalf_sized[0:10,0:10])
