...
#%%
filter_files= glob.glob(folder+'/*{0}*rmbkg.fits'.format(filt))  #For NIRCam
filter_files.sort()
...
if re_select == True:
    for filename in filter_files:
        ...
        #PSF works.
        data_process.find_PSF(radius = 45, user_option = True, if_filter=False, nearyby_obj_filter=False, FWHM_sort=True)
