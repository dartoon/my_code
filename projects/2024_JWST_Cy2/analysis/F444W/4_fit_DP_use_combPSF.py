...
# -*- coding: utf-8 -*-
"""
Created on Fri Oct 28 15:08:18 2022
...
idx = 1 #!!!
dp_files = glob.glob(run_folder  + 'fit_material/data_process_*{0}*CombPsfs*.pkl'.format(filt, idx) ) 
dp_files.sort()
import sys
...
for i in range(len(dp_files)):
    ...
    fit_sepc.prepare_fitting_seq(point_source_num = 1, fix_n_list=[[0,1]], supersampling_factor = 3)
