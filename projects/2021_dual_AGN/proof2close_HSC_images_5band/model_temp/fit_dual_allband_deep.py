...
from galight.tools.measure_tools import find_loc_max, measure_FWHM, twoD_Gaussian, fit_data_twoD_Gaussian #, esti_bgkstd
...
for image_ID in ID_list:
    ...
    fit_folder = image_folder + 'deep_fit_result/'
    ...
    for k in run_list:  #Search for Dual Based on I band.
        ...
        wcs = WCS(file_header)
        write_result =  open(fit_folder+'deep_fit_result_{0}-band.txt'.format(band_seq[k]),'w') 
        ...
        _fit_sepc_0 = FittingSpecify(data_process_list[k])
        ...
        _fit_sepc_1 = FittingSpecify(data_process_list[k])
        ...
        _fit_sepc_2 = FittingSpecify(data_process_list[k])
