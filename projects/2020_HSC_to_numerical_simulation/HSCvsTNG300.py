...
obj=ax
panel2=obj.hist2d(TNG300['Stellar_Mass'], TNG300['BH_Mass'],
...
sm_int, bh_int = TNG300['Stellar_Mass'], TNG300['BH_Mass']
sm_sim, bh_sim = TNG300['Stellar_Mass_nois_sl'], TNG300['BH_Mass_nois_sl']
...
#           label=('TNG300 sample scatter'), linewidth = 2, color='plum')
