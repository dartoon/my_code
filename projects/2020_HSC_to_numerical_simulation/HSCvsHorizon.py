...
for ii in range(1):
    ...
    # plt.scatter(Horizon['Stellar_Mass_nois_sl'], Horizon['BH_Mass_nois_sl'],c='m',
    #             s=220, marker=".",zorder=0, edgecolors='k', alpha = 0.7, label='Horizon-AGN sample z={0}'.format(zs))
    ...
    panel2=obj.hist2d(Horizon['Stellar_Mass'], Horizon['BH_Mass'],
    ...
    sm_int, bh_int = Horizon['Stellar_Mass']- detlaM, Horizon['BH_Mass']
    sm_sim, bh_sim = Horizon['Stellar_Mass_nois_sl']- detlaM, Horizon['BH_Mass_nois_sl']
    ...
    plt.hist(Horizon_scatter_nosl, histtype=u'step',density=True,
              label=('Horizon-AGN sample scatter nosl'), linewidth = 2, color='gray')
    plt.hist(Horizon_scatter,histtype=u'step',density=True,
              label=('Horizon-AGN sample scatter'), linewidth = 2, color='m')
    ...
    #           label=('Horizon-AGN sample scatter, no selection'), linewidth = 2, color='gray')
