...
ifplot = False
# zs = 0.3
imf_dict = {'MBII': 'Sal', 'SAM': 'Sal', 'TNG100': 'Cha', 'Illustris': 'Cha', 'Horizon': 'Sal'}
...
def load_HSC_comp(zs):
    ...
    sim_dict['MBII'] = TNG_set(filename_dict['MBII'], HSC_Lbol_overall=HSC_dict[imf_dict['MBII']]['HSC_Lbol_overall'], 
                  ...
                  I_mag_break = I_mag_break, imf = imf_dict['MBII'])
    sim_dict['SAM'] = SAM_set(filename_dict['SAM'], zs=zs, HSC_Lbol_overall=HSC_dict[imf_dict['SAM']]['HSC_Lbol_overall'], 
                  ...
                  I_mag_break = [20.5,22.0 ], imf =  imf_dict['SAM'])
    ...
    sim_dict['TNG100'] = TNG_set(filename_dict['TNG100'], HSC_Lbol_overall=HSC_dict[imf_dict['TNG100']]['HSC_Lbol_overall'], 
                  ...
                  I_mag_break = I_mag_break, imf =  imf_dict['TNG100'])
    sim_dict['Illustris'] = TNG_set(filename_dict['Illustris'], HSC_Lbol_overall=HSC_dict[imf_dict['Illustris']]['HSC_Lbol_overall'], 
                        ...
                        I_mag_break = I_mag_break, imf =  imf_dict['Illustris'])
    sim_dict['Horizon'] = Horizon_set(filename_dict['Horizon'], HSC_Lbol_overall=HSC_dict[imf_dict['Horizon']]['HSC_Lbol_overall'], 
                  ...
                  zs = zs, I_mag_break = I_mag_break, imf =  imf_dict['Horizon'])
    return HSC_dict, sim_dict
#%%
def prep_sim_hst(bhmass_overall,mstar_overall,Eddr_overall, imf):
...
def load_HST_comp():
    ...
    for i in range(len(load)):
        ...
        sim_dict[load[i]] = prep_sim_hst(bhmass_overall,mstar_overall,Eddr_overall, imf=imf_dict[load[i]])
    ...
    sim_dict['Horizon'] = prep_sim_hst(bhmass_overall,mstar_overall,Eddr_overall, imf=imf_dict['Horizon'])
    _HSC = HSC_set(zs)
    ...
    sim_dict['SAM'] = prep_sim_hst(bhmass_overall,mstar_overall,Eddr_overall, imf=imf_dict['SAM'])
