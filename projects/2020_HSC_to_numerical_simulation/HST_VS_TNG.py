...
for ii in range(1):
    ...
    obj.errorbar(mstar_selected,bhmass_selected,zorder=1,
                 color='deeppink',label='TNG100 population',linestyle=' ',marker='o',ms=10,mec='k')
    ...
    plt.plot(x_space, y_space, color='deeppink',linewidth=3, zorder = 101)
    ...
    rfilename = 'MC_result/' + 'TNG100_zs{0}_fixm1.txt'.format(zs)
