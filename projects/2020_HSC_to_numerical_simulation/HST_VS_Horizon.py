...
plt.errorbar(bhmass_select_noi, Eddr_select_noi, c='steelblue',linestyle=' ',marker='o',ms=10,mec='k', label='selected Horizon sample')
...
obj.errorbar(mstar_selected,bhmass_selected,zorder=1,
             color='steelblue',label='Horizon population',linestyle=' ',marker='o',ms=10,mec='k')
