...
obj=ax
panel2=obj.hist2d(Illustris['Stellar_Mass'], Illustris['BH_Mass'],
...
sm_int, bh_int = Illustris['Stellar_Mass'], Illustris['BH_Mass']
sm_sim, bh_sim = Illustris['Stellar_Mass_nois_sl'], Illustris['BH_Mass_nois_sl']
