...
The close correlations between \red{the mass of} supermassive black holes (\red{\mbh}) and the properties of their host galaxies (e.g., stellar mass\red{, \smass}) indicate a physical coupling during their joint evolution~\citep{Mag++98, F+M00, M+H03, H+R04, Gul++09}. To understand the nature of this connection, considerable efforts have been focused on measuring such correlations using broad-line active galactic nucleus (AGN) over a range of redshifts with the intention to determine how and when the correlation emerges and evolves over cosmic time \citep[e.g.,][]{Tre++04,Peng2006a, Tre++07, Woo++08, Jahnke2009, Bennert11, Schramm2013, Park15, Mechtley2016, Ding2020, 2021arXiv210902751L}. While, an {\it observed} evolution has been found \red{at redshift range xxx} in many studies \todo{move ref} in which the growth of BHs predates that of the host, other studies predict \todo{move ref} that BHs grow commensurately with galaxies.
...
including the Magneticum Pathfinder smooth-particle hydrodynamics (SPH) Simulations~\citep{Steinborn2015}, the Evolution and Assembly of Galaxies and their Environments~(EAGLE) suite of SPH \red{simulations~\citep{Schaye2015, Crain2015, McAlpine2016},} Illustris moving-mesh \red{simulation~\citep{Genel2014, 2014MNRAS.444.1518V, Sijacki2015, Nelson2015, Li2019}} and the SIMBA \red{simulation~\citep{Thomas2019, Dave2019}. }
...
\enddata
\tablecomments{In the penultimate row, $\alpha$ is the boost factor. For Illustris, $\alpha = 100$; for Horizon-AGN, $\alpha =$ max$[(\rho/\rho_0)^2, 1]$. $\dot{M}_{Bondi}= 4\pi G^2M_{BH}^2 \rho/c_s^3$. \todo{The $\leq$ sign in the low accretion feedback mode of TNG is also not clear. Is it a fixed value or a distribution?} \todo{Please mention whether the same radiative efficiency is used to compute AGN luminosity in all the simulations.}
}
\end{deluxetable*}
...
{\it right}: Similar to the panel on the left, this figure presents the impact of selection on the HST sample. For visual comparison between the HSC and HST selection, we show the region of the HST selection window in the left panel as dashed lines. \todo{No mention of the redshift in Fig.2}
}
\end{figure*}
...
We assume the following measurement uncertainties that are added as random noise: $\Delta$\mbh$ = 0.4~$dex, $\Delta$\smass$ = \red{0.2}~$dex, and $\Delta L_{\rm bol} = 0.03~$dex. 
...
\todo{A little discussion on the \smass\ P16. And address the properties what does it mean by intrinsic. P9+P12}


\section{Results} \label{sec:result}
%\todo{Explain the offset depends.}
\red{For comparison purpose, the local scaling relation introduced by D20 (e.g., \mbh$=0.98$\smass$-2.56$, Chabrier IMF\footnote{Since different simulations adopt either a Chabrier or a Salpeter IMF, we use the local relation and \smass\ of the observational data that are based on the same IMF thus a comparison between the observations and simulations are self-consistent.}) is adopted as the fiducial relation to assess relative offsets and differences in dispersion. \todo{Explain how D20's local is obtained and why it is IMF related. P10}}
...
Black hole mass versus stellar mass for both the observational (small orange circles) and simulated (small colored circles) samples. Each row pertains to a particular simulation as labelled. The panels, from left to right, show different redshift bins. The black line in each panel indicates the local relation adopted by~\citet{Ding2020}. The background cloud (in green and yellow) shows the intrinsic simulation number density before injecting random noise and applying selection effects. Only TNG100 is presented here since TNG300 presents very similar results \red{(see discussion section)}.
}
\end{figure*} 
...
SAM & (0.72$\pm$0.20)$\rightarrow$(0.73$\pm$0.49) & (0.64$\pm$0.18)$\rightarrow$(0.65$\pm$0.46)  &(0.56$\pm$0.16)$\rightarrow$(0.51$\pm$0.45)  &  (0.08$\pm$0.18)$\rightarrow$(0.51$\pm$0.36) & Salpeter \\
MBII & (-0.15$\pm$0.21)$\rightarrow$(-0.15$\pm$0.48) & \multicolumn{2}{c}{[$z=0.6$] (-0.15$\pm$0.22)$\rightarrow$(-0.16$\pm$0.48)}  & (0.08$\pm$0.19)$\rightarrow$(0.14$\pm$0.31) & Salpeter\\
Illustris & (0.03$\pm$0.32)$\rightarrow$(0.01$\pm$0.52) & (0.10$\pm$0.36)$\rightarrow$(0.08$\pm$0.53)  &(0.08$\pm$0.36)$\rightarrow$(0.06$\pm$0.54)  &  (0.04$\pm$0.19)$\rightarrow$(0.07$\pm$0.32) &  Chabrier \\
TNG100 & (0.27$\pm$0.20)$\rightarrow$(0.27$\pm$0.48) & (0.27$\pm$0.15)$\rightarrow$(0.24$\pm$0.46)  &(0.26$\pm$0.16)$\rightarrow$(0.24$\pm$0.45)  &  (0.36$\pm$0.15)$\rightarrow$(0.38$\pm$0.33) & Chabrier \\
TNG300 & (0.25$\pm$0.21)$\rightarrow$(0.26$\pm$0.48) & (0.19$\pm$0.23)$\rightarrow$(0.20$\pm$0.48)  &(0.20$\pm$0.22)$\rightarrow$(0.17$\pm$0.48)  &  (0.32$\pm$0.16)$\rightarrow$(0.41$\pm$0.34) & Chabrier \\
Horizon & (0.19$\pm$0.26)$\rightarrow$(0.16$\pm$0.49) & (0.18$\pm$0.21)$\rightarrow$(0.14$\pm$0.47)  &(0.28$\pm$0.20)$\rightarrow$(0.23$\pm$0.47)  &  (0.37$\pm$0.13)$\rightarrow$(0.47$\pm$0.35) & Salpeter\\
%SAM & (0.72, 0.20) $\rightarrow$ (0.73, 0.49) & (0.65, 0.46)  & (0.51, 0.45)  & (0.51, 0.36) & Salpeter \\
%Illustris & (0.03, 0.32) $\rightarrow$ (0.01, 0.52) & (0.08, 0.53)  & (0.06, 0.54)  & (0.07, 0.32) &  Chabrier \\
%TNG100 & (0.27, 0.20) $\rightarrow$ (0.27, 0.48) & (0.24, 0.46)  & (0.24, 0.45)  & (0.38, 0.33) & Chabrier \\
%TNG300 & (0.25, 0.21) $\rightarrow$ (0.26, 0.48) & (0.20, 0.48)  & (0.17, 0.48)  & (0.41, 0.34) & Chabrier \\
%Horizon & (0.19, 0.26) $\rightarrow$ (0.16, 0.49) & (0.14, 0.47)  & (0.23, 0.47)  & (0.47, 0.35) & Salpeter\\
\enddata
\tabletypesize{\normalsize}
...
\todo{QSO selection. Lbol vary and QSO II type. P7}

\todo{Discussion when shift offset as z=0.3. P11}

\todo{Discussion how random make difference on the scatter. P13}

\todo{Discussion on the \smass of the simulation and why IMF is part of the picture. P16}
...
\startdata
SAM &  3.12e-09 & $<$1e-10  & $<$1e-10  & 7.46e-03  \\
MBII & 4.23e-02 & \multicolumn{2}{c}{$<$1e-10 [$z=0.6$]}  & 2.22e-06  \\
Illustris & 2.31e-01 & 6.14e-02  & 9.96e-03  & 2.33e-07  \\
TNG100 & 1.21e-02 & 2.53e-01  & 3.76e-01  & 4.71e-01  \\
TNG300 & 1.82e-02 & 9.19e-01  & 1.21e-01  & 2.12e-01  \\
Horizon-AGN & 2.70e-01 & 2.87e-01  & 6.13e-01  & 1.95e-01  \\
\enddata
