...
# for target_id, RA, Dec, z, file in targets_info[:2]:
# for target_id, RA, Dec, z, file in targets_info[2:4]:
# for target_id, RA, Dec, z, file in targets_info[4:7]:
# for target_id, RA, Dec, z, file in targets_info[7:10]:
for target_id, RA, Dec, z, file in targets_info[7:8]:
    ...
    # wcs = WCS(header)
    # sky = wcs.pixel_to_world(data_process.target_pos[0], data_process.target_pos[1])
    ...
    for i in range(len(PSF_list)):
        ...
        fit_run = FittingProcess(fit_sepc, savename = target_id, fitting_level=['norm','norm'])
