...
idx = 1153  #sfr_image[22,31]
# idx = 1603  #sfr_image[31,22]

# _, z = load_info(idx)
# target_id = name_list[idx]

print(idx)
steller_file = glob.glob('/Users/Dartoon/Downloads/bin_2/'+folder+str(idx)+'/SFH_*.fits')[0]
...
print('open', '/Users/Dartoon/Downloads/bin_2/'+folder+str(idx)+'/SPEC_*_spec.png')
#%%
...
# spec1d_file = glob.glob('/Users/Dartoon/Downloads/bin_2/'+folder+str(idx)+'/gsf_spec*.fits')[0]
