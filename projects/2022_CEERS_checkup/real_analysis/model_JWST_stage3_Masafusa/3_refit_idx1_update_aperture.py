...
# -*- coding: utf-8 -*-
"""
Created on Sun Aug 28 00:20:33 2022
...
for file in files[1:]:
    ...
    aperture.positions = [30, 69]
    aperture.a, aperture.b = 3, 3
    ...
    shutil.copyfile(file, 'backup_'+file)
    # filt = _data_process.filt
    pickle.dump(fit_run , open(file, 'wb'))