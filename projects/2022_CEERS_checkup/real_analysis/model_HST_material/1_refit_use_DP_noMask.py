...
for i in range(3379):
    ...
    # _data_process.target_mask = np.ones_like(_data_process.target_stamp)
    if np.sum(_data_process.target_mask == False) > 10:
        # i_list.append([i, file])
