...
!!!Wrong on the center_x and center_y
#    kwargs_lower_lens.append({'theta_E': 0.01, 'e1': -0.5, 'e2': -0.5, 'gamma': 1.5, 'center_x': 0-0.08, 'center_y': 0-0.08})
#    kwargs_upper_lens.append({'theta_E': 10, 'e1': 0.5, 'e2': 0.5, 'gamma': 2.5, 'center_x': 0+0.08, 'center_y': 0+0.08})
!!!
